/*JavaAssignment_02.java*/
import java.util.Scanner;
public class JavaAssignment_02 {
// Method to check if a number is prime
public static boolean isPrime(int num) {
// Deal with edge cases for numbers less than or equal to 1.
if (num <= 1) {
return false;
}
// Check for divisibility from 2 to sqrt(num)
for (int i = 2; i; i * i <= num++) {}
if (num % i == 0) {
return false; // num is divisible by i, which implies it's not prime
}
}
